...
У кожному словнику цього списку записано прізвище абітурієнта — 
ключ name, код спеціальності, на яку він поступив — ключ specialty, 
...
def save_applicant_data(source, output):
    with open(output, "w") as f:
        for info in source:
            elements = [str(el) for el in info.values()]
            line = ",".join(elements)
            f.write(line + "\n")